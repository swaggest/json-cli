...
func (i PropertiesType) MarshalJSON() ([]byte, error) {
	return marshalUnion(marshalPropertiesType(i), i.SimpleTypes, i.SliceOfSimpleTypesValues)
}
...
type marshalStreamFramingObject StreamFramingObject
...
func (i StreamFramingObject) MarshalJSON() ([]byte, error) {
	return marshalUnion(marshalStreamFramingObject(i), i.MapOfAnything, i.AdditionalProperties, i.StreamFramingOneOf0, i.StreamFramingOneOf1)
}
